...
namespace FlickrNet
{
    ...
    public class Flickr
    {
        ...
        /// <summary>
        /// Returns a <see cref="PoolGroups"/> that match the text specified.
        /// </summary>
        /// <param name="text">text used to search for groups</param>
        /// <returns>A <see cref="PoolGroups"/> instance.</returns>
        ...
        /// </summary>
        /// <param name="catId"></param>
        /// <param name="perPage">Number of groups to include per page.</param>
        /// <param name="page">The page to download this time.</param>
        /// <returns>A <see cref="PoolGroups"/> instance.</returns>
