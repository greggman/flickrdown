...
namespace FlickrNet
{
    ...
    public class Flickr
    {
        ...
        {
            return PhotosetsGetPhotos(photosetId, PhotoSearchExtras.All, PrivacyFilter.None, 1);
        }
        ...
        /// <param name="photosetId">The ID of the photoset to return photos for.</param>
        /// <returns>An array of <see cref="Photo"/> instances.</returns>
        public Photo[] PhotosetsGetPhotos(string photosetId, int page)
        {
            return PhotosetsGetPhotos(photosetId, PhotoSearchExtras.All, PrivacyFilter.None, page);
        }
        ...
        {
            return PhotosetsGetPhotos(photosetId, PhotoSearchExtras.All, privacyFilter, 1);
        }
        ...
        {
            return PhotosetsGetPhotos(photosetId, extras, PrivacyFilter.None, 1);
        }
        ...
        /// <param name="privacyFilter">The privacy filter to search on.</param>
        /// <returns>An array of <see cref="Photo"/> instances.</returns>
        public Photo[] PhotosetsGetPhotos(string photosetId, PhotoSearchExtras extras, PrivacyFilter privacyFilter, int page)
        {
            Hashtable parameters = new Hashtable();
